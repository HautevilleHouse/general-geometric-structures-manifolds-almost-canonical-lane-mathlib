...
def sourceRepository : String := "general-geometric-structures-manifolds-almost-canonical-lane"

def sourceDescription : String := "General Geometric Structures Manifolds Almost"
